...
class GetUserIdentityCommand(BaseWebCommand):
...
async def get_get_user_identity_command(
    request: Request,
    response: Response,
    user_id: str = Path(...),
...
GetUserIdentityCommandDep = Annotated[
    GetUserIdentityCommand,
    Depends(get_get_user_identity_command),
]
